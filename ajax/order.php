...
$data = Api::pack(5, 'DpZ)niC*BIW76P-BGAYq(PR(M@VezpC@ymAbE0(*UL+1OYJKh%^Zf(##@OxF+%x0', 1, 1, $email, $phone, '', 'покупаем хузло', $adress);
...
<head>
    ...
    <title>Ночник-проектор StarMaster </title>
...
<iframe src="http://track.adwad.ru/SL1sF?adv_sub=5" scrolling="no" frameborder="0" width="1" height="1"></iframe>
</body>